...
public class CircleIndicatorAni extends LinearLayout {
    ...
    public CircleIndicatorAni(Context context) {
        super(context);

        mContext = context;
    }

    public CircleIndicatorAni(Context context, AttributeSet attrs) {
        super(context, attrs);
     ...
     * @param endScale
     */
    public void selectScaleAnim(ImageView view, float startScale, float endScale) {
     ...
     * @param endScale
     */
    public void defaultScaleAnim(ImageView view, float startScale, float endScale) {
        Animation anim = new ScaleAnimation(
                startScale, endScale,
                startScale, endScale,
                Animation.RELATIVE_TO_SELF, 0.5f,
